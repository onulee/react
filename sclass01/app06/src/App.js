    ...
    <div className='app_main'>
      ...
      <div className="card text-center">
        ...
        <div className="card-body">
          <h5 className="card-title">제목 : {movies[0].title}</h5>
          <p className="card-text">제작년도 : {movies[0].year}년</p>
      ...
      <div className="card text-center">
        ...
        <div className="card-body">
          <h5 className="card-title">제목 : {movies[1].title}</h5>
          <p className="card-text">제작년도 : {movies[1].year}년</p>
          <a href="#" className="btn btn-primary">수정</a>
          <a href="#" className="btn btn-primary">삭제</a>
        </div>
        <div className="card-footer text-body-secondary">
